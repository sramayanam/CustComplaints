...
-- ----------------------------------------------------------------------------
-- SYNTHETIC DATA NOTICE: All records in this file — including names, email
-- addresses, phone numbers, flight details, and complaint descriptions — are
-- entirely fictitious and were generated by a Large Language Model (LLM) for
-- demonstration purposes only. They do not represent real individuals,
-- airlines, flights, or customer complaints. Any resemblance to real people
